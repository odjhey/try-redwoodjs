...
import CoreOrganization from 'src/components/CoreOrganization/CoreOrganization'
...
export const Success = ({ coreOrganization }: CellSuccessProps<FindCoreOrganizationById>) => {
