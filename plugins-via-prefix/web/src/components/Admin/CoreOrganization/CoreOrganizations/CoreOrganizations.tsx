...
import { QUERY } from 'src/components/Admin/CoreOrganization/CoreOrganizationsCell'
...
const CoreOrganizationsList = ({ coreOrganizations }) => {
  const [deleteCoreOrganization] = useMutation(
    DELETE_CORE_ORGANIZATION_MUTATION,
    {
      onCompleted: () => {
  ...
  const onDeleteClick = (id) => {
    if (
      confirm('Are you sure you want to delete coreOrganization ' + id + '?')
    ) {
            ...
            <tr key={coreOrganization.id}>
              ...
              <td>
                <nav className="rw-table-actions">
                  <Link
                    to={routes.adminCoreOrganization({
                      id: coreOrganization.id,
                    })}
                    title={
                      'Show coreOrganization ' + coreOrganization.id + ' detail'
                    }
                  ...
                  <Link
                    to={routes.adminEditCoreOrganization({
                      id: coreOrganization.id,
                    })}
